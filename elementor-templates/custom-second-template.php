...
<div class="self-stretch flex flex-row items-center justify-start flex-wrap content-center gap-[40px] text-41xl text-general-1-primary font-button-dm-sans-16 mq950:gap-[10px]  mq950:gap-x-[5px] mq950:items-start   items-start mq650:gap-x-[0px]">
					...
					<div class=" flex flex-col items-start justify-start gap-[10px] min-w-[206px] max-w-[262px] mq650:w-[50%] mq950:w-[23%] mq650:min-w-[100px]  mq950:min-w-[150px] ">
						...
						<b class="relative tracking-[-0.03em] leading-[66px] mq450:text-17xl mq450:leading-[40px] mq850:text-29xl mq850:leading-[53px] transition-[_--num] duration-[3s] ease-out [counter-set:_num_var(--num)] supports-[counter-set]:before:content-[counter(num)] [--num:100]" x-data="{ shown: false }" x-intersect="shown = true" :class="shown &amp;&amp; '[--num:100]'">
					...
					<div class=" flex flex-col items-start justify-start gap-[10px] min-w-[206px] max-w-[262px] mq650:w-[50%] mq950:w-[23%] mq650:min-w-[100px]  mq950:min-w-[150px]">
						...
						<b class="relative tracking-[-0.03em] leading-[66px] mq450:text-17xl mq450:leading-[40px] mq850:text-29xl mq850:leading-[53px] transition-[_--num] duration-[3s] ease-out [counter-set:_num_var(--num)] supports-[counter-set]:before:content-[counter(num)] [--num:2500]" x-data="{ shown: false }" x-intersect="shown = true" :class="shown &amp;&amp; '[--num:2500]'">
					...
					<div class=" flex flex-col items-start justify-start gap-[10px] min-w-[206px] max-w-[262px] mq650:w-[50%] mq950:w-[23%] mq650:min-w-[100px] text-center  mq950:min-w-[150px]">
						<b class="relative tracking-[-0.03em] leading-[66px] mq450:text-17xl mq450:leading-[40px] mq850:text-29xl mq850:leading-[53px] transition-[_--num] duration-[3s] ease-out [counter-set:_num_var(--num)] supports-[counter-set]:before:content-[counter(num)] [--num:5000]" x-data="{ shown: false }" x-intersect="shown = true" :class="shown &amp;&amp; '[--num:5000]'">
