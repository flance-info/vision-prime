	...
	<div class="w-full">
		...
		<section class="self-stretch flex flex-row items-start justify-center pt-0  pb-[180px] box-border max-w-full text-left text-base text-general-1-primary font-subtitles-16 lg:pb-[117px] lg:box-border mq850:pb-[76px] mq850:box-border">
			<div class="w-[1170px] flex flex-col items-start justify-start gap-[60px] max-w-full lg:gap-[30px] lg:mx-[20px]">
				...
				<div
						class="self-stretch flex flex-col items-start justify-start gap-[60px] max-w-full text-left text-general-9-secondary-variant font-body-b3-merriweather-14 mq1425:gap-[30px]"
				>
					<div
							class="self-stretch flex flex-row items-start justify-start flex-wrap content-start gap-[30px] max-w-full"
					>
						<div
								class="flex-1 relative leading-[26px] inline-block min-w-[370px] max-w-full mq450:min-w-full"
						>
							<p class="m-[0px]">
					...
					<div
							class="self-stretch flex flex-row items-center justify-start flex-wrap content-center gap-[40px] text-41xl text-general-1-primary font-button-dm-sans-16 mq950:gap-[20px]"
					>


						<div
								class="flex-1 flex flex-col items-start justify-start gap-[10px] min-w-[206px] max-w-[262px]"
						>


							<b class="relative tracking-[-0.03em] leading-[66px] mq450:text-17xl mq450:leading-[40px] mq850:text-29xl mq850:leading-[53px]
							...
							<div
									class="self-stretch relative text-lg leading-[30px] font-body-b3-merriweather-14 text-general-9-secondary-variant"
							>
								years of experience
							</div>
						</div>
...
<b class="relative tracking-[-0.03em] leading-[66px] mq450:text-17xl mq450:leading-[40px] mq850:text-29xl mq850:leading-[53px]
									 transition-[_--num] duration-[3s] ease-out [counter-set:_num_var(--num)] supports-[counter-set]:before:content-[counter(num)]"
						...
						<div
								class="flex-1 flex flex-col items-start justify-start gap-[10px] min-w-[206px] max-w-[262px] text-center"
						>
							<b class="relative tracking-[-0.03em] leading-[66px] mq450:text-17xl mq450:leading-[40px] mq850:text-29xl mq850:leading-[53px]
									 transition-[_--num] duration-[3s] ease-out [counter-set:_num_var(--num)] supports-[counter-set]:before:content-[counter(num)]"
							...
							<div
									class="self-stretch relative text-lg leading-[30px] font-body-b3-merriweather-14 text-general-9-secondary-variant text-left"
							>
								audit completed
							</div>
						</div>
		...
		<section
				class="self-stretch flex flex-col items-center justify-between pt-0 px-0 ] box-border max-w-full text-left text-base text-general-white font-heading-1-72 ">
			<div class="w-full flex flex-row items-start justify-start relative max-w-full ml-[10%] lg:ml-[0px]">
				...
				<div class="flex-1 flex flex-col items-center justify-start pt-0 pb-[110px] box-border gap-10 bg-dark-gray max-w-full z-[3] lg:pl-[140px] lg:pr-[140px] lg:pb-[71px] lg:box-border mq450:pl-5 mq450:pr-5 mq450:pb-[46px] mq450:box-border mq850:gap-10 mq850:box-border">
					<div class="w-full max-w-[1170px] ml-[calc(91%-100vw)] gap-6 flex flex-col items-center lg:ml-[0px]">
						...
						<div class="w-[1140px] flex flex-row items-start justify-center flex-wrap content-start gap-[30px] max-w-full font-body-b3-merriweather-14 mt-[50px]">
							<div
									class="flex-1 flex flex-col items-start justify-start gap-[40px] min-w-[367px] max-w-full mq950:gap-[20px] mq950:min-w-full "
							>
								<div
										class="self-stretch overflow-hidden flex flex-col items-start justify-start gap-[16px]"
								>
									<h3
											class="m-[0px] self-stretch relative text-inherit tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]"
									>
										Partnership
									</h3>
									<div
											class="self-stretch relative text-sm leading-[24px] font-body-b3-merriweather-14 text-[#878995]"
									>
								...
								<div
										class="self-stretch overflow-hidden flex flex-col items-start justify-start pt-[0px] px-[0px] pb-[2px] gap-[16px]"
								>
									<h3
											class="m-[0px] self-stretch relative text-inherit tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]"
									>
		...
		<div
				class="w-[120px] h-[1px] relative bg-general-white [transform:_rotate(90deg)] hidden z-[7]"
		></div>


		<section
				class="self-stretch bg-elements-neutral-4 flex flex-col items-center justify-start pt-[22px] px-5 pb-[171px] box-border gap-[68px] max-w-full z-[3] text-center text-base text-general-1-primary font-subtitles-16  lg:pt-5 lg:pb-[111px] ">
			...
			<div class="w-[1170px] grid flex-row items-start justify-start gap-[30px] max-w-full grid-cols-[repeat(4,_minmax(202px,_1fr))] z-[1] text-left text-smi text-general-white font-button-dm-sans-16 lg:justify-center lg:grid-cols-[repeat(2,_minmax(202px,_351px))] mq450:grid-cols-[minmax(202px,_1fr)]">
				<div class="h-[375px] overflow-hidden overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/vision-prime/web/public/member-info@3x.png')] bg-cover bg-no-repeat bg-[top] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75">
					...
					<div class="overflow-hidden flex flex-row items-center justify-start gap-2.5">
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" loading="lazy" alt="" src="/wp-content/themes/vision-prime/web/public/link--facebook.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" loading="lazy" alt="" src="/wp-content/themes/vision-prime/web/public/link--twitter.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" alt="" src="/wp-content/themes/vision-prime/web/public/link--instagram.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" alt="" src="/wp-content/themes/vision-prime/web/public/link--pinterest.svg"></a>
					</div>
				</div>
				<div class="h-[375px] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75 overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/vision-prime/web/public/member-info1@3x.png')] bg-cover bg-no-repeat bg-[top]">
					...
					<div class="overflow-hidden flex flex-row items-center justify-start gap-2.5">
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="" src="/wp-content/themes/vision-prime/web/public/link--facebook.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="" src="/wp-content/themes/vision-prime/web/public/link--twitter.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="" src="/wp-content/themes/vision-prime/web/public/link--instagram.svg"></a>

						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="" src="/wp-content/themes/vision-prime/web/public/link--pinterest.svg"></a>
					</div>
				</div>
			...
			<div class="w-[1170px] grid flex-row items-start justify-start gap-[30px] max-w-full grid-cols-[repeat(4,_minmax(202px,_1fr))] z-[1] text-left text-smi text-general-white font-button-dm-sans-16 lg:justify-center lg:grid-cols-[repeat(2,_minmax(202px,_351px))] mq450:grid-cols-[minmax(202px,_1fr)]">
				...
				<div class="h-[375px] overflow-hidden overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/vision-prime/web/about/public/member-profiles1@3x.png')] bg-cover bg-no-repeat bg-[top] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Roxanna
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
					...
					<div class="overflow-hidden flex flex-row items-center justify-start gap-2.5">
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" loading="lazy" alt="Facebook"
							 src="/wp-content/themes/vision-prime/web/about/public/link--facebook.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" loading="lazy" alt="Twitter"
							 src="/wp-content/themes/vision-prime/web/about/public/link--twitter.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" alt="Instagram" src="/wp-content/themes/vision-prime/web/about/public/link--instagram.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px] transition-transform duration-300 ease-in-out hover:scale-110" alt="Pinterest" src="/wp-content/themes/vision-prime/web/about/public/link--pinterest.svg"></a>
					</div>
				</div>

				<!-- Team Member 2: Boris -->
				<div class="h-[375px] transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-opacity-75 overflow-hidden flex flex-col items-start justify-end py-[25px] pl-[25px] pr-5 box-border gap-[5px] bg-[url('/wp-content/themes/vision-prime/web/about/public/member-profiles2@3x.png')] bg-cover bg-no-repeat bg-[top]">
					<h3 class="m-0 self-stretch relative text-5xl tracking-[-0.01em] leading-[30px] font-bold font-inherit mq450:text-lgi mq450:leading-[24px]">
						Boris
					</h3>
					<div class="relative leading-[22px] font-body-b3-merriweather-14">
					...
					<div class="overflow-hidden flex flex-row items-center justify-start gap-2.5">
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="Facebook" src="/wp-content/themes/vision-prime/web/about/public/link--facebook.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="Twitter" src="/wp-content/themes/vision-prime/web/about/public/link--twitter.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="Instagram" src="/wp-content/themes/vision-prime/web/about/public/link--instagram.svg"></a>
						<a href="#"> <img class="h-[33px] w-[33px] relative rounded min-h-[33px]" alt="Pinterest" src="/wp-content/themes/vision-prime/web/about/public/link--pinterest.svg"></a>
					</div>
				</div>
											...
											<div class="self-stretch flex flex-col items-end justify-start gap-14 max-w-full mq850:gap-7">
												<div class="self-stretch flex flex-row items-start justify-end py-0 pl-[49px] pr-[41px] box-border max-w-full lg:pl-6 lg:box-border">
													<div class="w-[980px] flex flex-row items-start justify-start gap-[42px] max-w-full mq950:gap-[21px] mq1425:flex-wrap">
														<img class="w-[330px] relative max-h-full overflow-hidden shrink-0 min-h-[198px] max-w-full z-[4] mq1425:flex-1" loading="lazy" alt=""
															 src="/wp-content/themes/vision-prime/web/about/public/girl.png">
...
<section class="self-stretch bg-general-white flex flex-col items-center justify-start pt-[22px] pb-[89px] pl-[22px]
		...
		<div class="w-[124px] hidden flex-row items-end justify-start gap-[1px]">
			<b class="h-[24px] flex-1 relative leading-[24px] flex items-end"
			>Get details</b
			>
			<div class="h-[24px] w-[24px] relative">
				<img
						class="absolute top-[2px] left-[2px] w-[22px] h-[22px]"
						alt=""
						src="/wp-content/themes/vision-prime/web/about/public/iconsiconly-blacklightarrow-chevronright.svg"
				/>

				<div
						class="absolute top-[12px] left-[3px] bg-general-1-primary w-[12px] h-[2px]"
				></div>
			</div>
		</div>
		<b
				class="w-[130px] h-0 relative text-base leading-[22px] uppercase hidden"
		>What We Offer</b
		>
		...
		<section
				class="self-stretch flex flex-row items-start justify-center pt-0  pb-[180px] box-border max-w-full text-left text-base text-general-1-primary font-subtitles-16 lg:pb-[117px] lg:box-border mq850:pb-[76px] mq850:box-border bg-elements-neutral-4">
			<div class="w-[1170px] flex flex-col items-start justify-start gap-[60px] max-w-full lg:gap-[30px] lg:mx-[20px]">
				<div class="self-stretch flex flex-col items-start justify-center py-0  box-border max-w-full text-center">
					<div class="h-[120px] relative block left-[50%] ">
						<div class="h-px w-[120px] !m-[0] top-[-79px]  bg-general-1-primary [transform:_rotate(90deg)] [transform-origin:0_0]"></div>
				...
				<div
						class="self-stretch flex flex-col items-start justify-start gap-[60px] max-w-full text-left text-general-8-secondary font-body-b3-merriweather-14 mq1425:gap-[30px]"
				>
					<div
							class="self-stretch flex flex-row items-start justify-start flex-wrap content-start gap-[30px] max-w-full"
					>
